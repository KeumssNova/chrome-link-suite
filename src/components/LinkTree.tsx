...
const LinkTree = () => {
  ...
  const [blocks, setBlocks] = useState<Block[]>([
    ...
    },
    {
      ...
      content:
        "Bienvenue sur ma page ! Vous trouverez ici tous mes liens et contenus préférés. N'hésitez pas à explorer.",
      style: "highlight",
      visible: true,
      order: 2,
    },
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-secondary rounded-full blur-3xl opacity-10 animate-float"
      ...
      <div className="relative z-10 container max-w-md mx-auto px-4 py-8">
        ...
        <Card className="futuristic-card mb-8 p-6 text-center">
          <div className="relative inline-block mb-4">
            <Avatar className="w-24 h-24 mx-auto ring-2 ring-primary glow-avatar overflow-hidden">
              <AvatarImage
                src={profile.avatar}
                alt={profile.name}
            ...
            {isEditing && (
              <Button
                size="sm"
                className="absolute -bottom-2 -right-2 rounded-full w-8 h-8 p-0 neon-button"
                asChild
              >
                <label
                  htmlFor="avatarInput"
