import { SpotifyBlock } from '@/types/block';
...
interface SpotifyBlockProps {
  block: SpotifyBlock;
  isEditing: boolean;
  onEdit?: (block: SpotifyBlock) => void;
  onDelete?: (blockId: string) => void;
  onToggleVisibility?: (blockId: string) => void;
}

const SpotifyBlockComponent = ({ block, isEditing, onEdit, onDelete, onToggleVisibility }: SpotifyBlockProps) => {
...
export default SpotifyBlockComponent;